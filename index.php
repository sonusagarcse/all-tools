...
<!-- ==================== HERO ==================== -->
<section class="relative min-h-[92vh] flex items-center overflow-hidden bg-white dark:bg-gray-950">

    <!-- Animated Background Orbs -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <div class="hero-orb w-[500px] h-[500px] bg-indigo-400/20 dark:bg-indigo-600/15 top-[-10%] left-[-8%] animate-blob"></div>
        <div class="hero-orb w-[400px] h-[400px] bg-purple-400/20 dark:bg-purple-600/15 top-[30%] right-[-5%] animate-blob" style="animation-delay:2s"></div>
        <div class="hero-orb w-[350px] h-[350px] bg-cyan-400/15 dark:bg-cyan-600/10 bottom-[-10%] left-[30%] animate-blob" style="animation-delay:4s"></div>
        <!-- Floating Particles -->
        <div class="absolute top-[15%] left-[20%] w-2 h-2 bg-indigo-400 rounded-full animate-float opacity-50"></div>
        <div class="absolute top-[40%] right-[25%] w-1.5 h-1.5 bg-purple-400 rounded-full animate-float" style="animation-delay:1.5s; opacity:0.4"></div>
        <div class="absolute bottom-[25%] left-[15%] w-2.5 h-2.5 bg-cyan-400 rounded-full animate-float2" style="animation-delay:0.8s; opacity:0.35"></div>
        <div class="absolute top-[60%] right-[15%] w-1.5 h-1.5 bg-pink-400 rounded-full animate-float" style="animation-delay:3s; opacity:0.45"></div>
        <!-- Grid pattern -->
        <div class="absolute inset-0 opacity-[0.02] dark:opacity-[0.04]" style="background-image: linear-gradient(rgba(99,102,241,1) 1px, transparent 1px), linear-gradient(to right, rgba(99,102,241,1) 1px, transparent 1px); background-size: 40px 40px;"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-heading font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight leading-[1.08] animate-fade-in" style="animation-delay:0.1s">
                    Powerful Tools,<br>
                    <span class="gradient-text">Zero Complexity.</span>
                </h1>

                <p class="text-slate-600 dark:text-gray-400 text-lg md:text-xl mb-10 leading-relaxed animate-fade-in font-medium max-w-xl" style="animation-delay:0.2s">
                    Compress images, process text, format code, and generate secure passwords — all in one place. Fast, free, and works right in your browser.
                </p>

                <!-- Search -->
                <div class="relative animate-fade-in mb-8" style="animation-delay:0.3s">
                    ...
                    <div class="absolute right-3 top-1/2 -translate-y-1/2">
                        <kbd class="px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-gray-800 text-slate-500 dark:text-gray-400 text-xs font-bold border border-slate-200 dark:border-gray-700">⌘K</kbd>
                    </div>
                </div>

                <!-- Trust Badges -->
                <div class="flex flex-wrap gap-3 animate-fade-in" style="animation-delay:0.4s">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-xs font-bold border border-green-100 dark:border-green-500/20">
                        <i data-lucide="shield-check" class="w-3.5 h-3.5"></i> 100% Secure
                    </span>
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 text-xs font-bold border border-indigo-100 dark:border-indigo-500/20">
                        <i data-lucide="zap" class="w-3.5 h-3.5"></i> Instant Results
                    </span>
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-400 text-xs font-bold border border-purple-100 dark:border-purple-500/20">
                        <i data-lucide="user-x" class="w-3.5 h-3.5"></i> No Registration
                    </span>
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-50 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 text-xs font-bold border border-cyan-100 dark:border-cyan-500/20">
            ...
            <div class="hidden lg:flex items-center justify-center relative">
                ...
                <div class="relative w-72 h-72 flex items-center justify-center">
                    <div class="absolute inset-0 rounded-full animate-spin-slow" style="border: 2px dashed rgba(99,102,241,0.2)"></div>
                    <div class="absolute inset-6 rounded-full animate-spin-slow" style="border: 1px dashed rgba(139,92,246,0.15); animation-direction:reverse; animation-duration:16s"></div>

                    <!-- Center logo -->
                    <div class="relative w-28 h-28 rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center shadow-2xl shadow-indigo-500/40 animate-float">
                ...
                <div class="absolute <?php echo $ot['pos']; ?> glass-card px-4 py-3 rounded-2xl border flex items-center gap-3 shadow-xl animate-float <?php echo $color_map[$ot['color']]; ?>" style="animation-delay:<?php echo $i * 0.8; ?>s">
                    <div class="w-9 h-9 rounded-xl flex items-center justify-center <?php echo $color_map[$ot['color']]; ?> border">
                        <i data-lucide="<?php echo $ot['icon']; ?>" class="w-4 h-4"></i>
                    </div>
                    <span class="text-xs font-bold text-slate-800 dark:text-white whitespace-nowrap"><?php echo $ot['label']; ?></span>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
            ...
            <div class="text-center reveal" style="transition-delay:<?php echo $i*0.1; ?>s">
                <div class="inline-flex items-center justify-center w-12 h-12 bg-indigo-50 dark:bg-indigo-600/10 rounded-2xl text-indigo-600 dark:text-indigo-400 mb-3 mx-auto">
                    <i data-lucide="<?php echo $s['icon']; ?>" class="w-5 h-5"></i>
                </div>
                <div class="text-4xl font-heading font-extrabold stat-value mb-1" data-count-target="<?php echo $s['val']; ?>"><?php echo $s['val']; ?></div>
                <div class="text-slate-500 dark:text-gray-500 text-xs uppercase tracking-widest font-bold"><?php echo $s['label']; ?></div>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="py-24 bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-950">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 reveal">
            <span class="inline-block px-4 py-1.5 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-widest rounded-full mb-4 border border-indigo-100 dark:border-indigo-500/20">Tool Categories</span>
            <h2 class="text-4xl md:text-5xl font-heading font-extrabold text-slate-900 dark:text-white mb-4">Everything You Need,<br><span class="gradient-text">Neatly Organized</span></h2>
            <p class="text-slate-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">From image editing to developer utilities — browse tools by category and find exactly what you're looking for.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            ?>
            <a href="#<?php echo $cat_id; ?>" class="cat-card glass-card p-8 rounded-3xl group flex flex-col items-center text-center reveal" style="transition-delay:<?php echo (array_search($cat_id, array_keys($TOOL_CATEGORIES)) * 0.1); ?>s">
                <div class="w-16 h-16 <?php echo $acc['bg']; ?> border <?php echo $acc['border']; ?> rounded-2xl flex items-center justify-center <?php echo $acc['text']; ?> mb-5 <?php echo $acc['hover_bg']; ?> group-hover:text-white group-hover:scale-110 transition-all duration-300 group-hover:shadow-lg">
                    <i data-lucide="<?php echo $category['icon']; ?>" class="w-8 h-8"></i>
                </div>
                <h3 class="text-xl font-heading font-bold text-slate-900 dark:text-white mb-2"><?php echo $category['name']; ?></h3>
                ...
                <div class="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest <?php echo $acc['text']; ?> group-hover:gap-3 transition-all animate-bounce-x">
...
<!-- ==================== TOOLS GRID ==================== -->
<?php $section_idx = 0; foreach ($TOOL_CATEGORIES as $cat_id => $category):
    $acc = $cat_accents[$cat_id] ?? $cat_accents['image'];
    $alt_bg = ($section_idx % 2 === 0) ? 'bg-white dark:bg-gray-950' : 'bg-slate-50 dark:bg-gray-900/30';
    $section_idx++;
?>
<section id="<?php echo $cat_id; ?>" class="py-24 category-section border-t border-slate-100 dark:border-gray-900 <?php echo $alt_bg; ?> relative overflow-hidden">
    <!-- Decorative BG Orb -->
    <div class="absolute -top-20 -right-20 w-80 h-80 <?php echo $acc['bg']; ?> rounded-full blur-[100px] opacity-50 pointer-events-none"></div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <!-- Section Header -->
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 reveal">
            <div class="flex items-center gap-4">
                <div class="p-3 <?php echo $acc['bg']; ?> border <?php echo $acc['border']; ?> rounded-2xl <?php echo $acc['text']; ?> shadow-sm">
                    <i data-lucide="<?php echo $category['icon']; ?>" class="w-7 h-7"></i>
                </div>
                <div>
                    <p class="text-xs font-bold uppercase tracking-widest <?php echo $acc['text']; ?> mb-1"><?php echo count($category['tools']); ?> tools available</p>
                    <h2 class="text-3xl md:text-4xl font-heading font-extrabold text-slate-900 dark:text-white"><?php echo $category['name']; ?></h2>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            <div class="tool-card glass-card rounded-2xl flex flex-col h-full border border-slate-200 dark:border-gray-800 reveal" style="transition-delay:0.05s">
                <div class="p-6 flex flex-col h-full">
                    <div class="w-11 h-11 <?php echo $acc['bg']; ?> border <?php echo $acc['border']; ?> rounded-xl flex items-center justify-center <?php echo $acc['text']; ?> mb-4 group-hover:scale-110 transition-transform">
                        <i data-lucide="<?php echo $category['icon']; ?>" class="w-5 h-5"></i>
                    </div>
                    <h3 class="text-base font-bold text-slate-900 dark:text-white mb-2"><?php echo $tool['name']; ?></h3>
                    <p class="text-slate-500 dark:text-gray-400 text-sm mb-6 flex-grow leading-relaxed"><?php echo $tool['desc']; ?></p>
...
<section class="py-28 bg-white dark:bg-gray-950 border-t border-slate-100 dark:border-gray-900 relative overflow-hidden">
    <div class="absolute inset-0 pointer-events-none -z-0">
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent"></div>
    </div>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-20 reveal">
            <span class="inline-block px-4 py-1.5 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-widest rounded-full mb-4 border border-indigo-100 dark:border-indigo-500/20">Simple Process</span>
            <h2 class="text-4xl md:text-5xl font-heading font-extrabold text-slate-900 dark:text-white mb-4">How It <span class="gradient-text">Works</span></h2>
            <p class="text-slate-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">Three simple steps is all it takes — no manuals, no tutorials, no waiting.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <!-- Connector lines for desktop -->
            <div class="hidden md:block absolute top-16 left-1/3 right-1/3 h-0.5 bg-gradient-to-r from-indigo-200 to-indigo-200 dark:from-indigo-800 dark:to-indigo-800" style="top:56px"></div>
            ...
            <div class="relative text-center px-4 reveal" style="transition-delay:<?php echo $i*0.15; ?>s">
                <div class="relative inline-block mb-8">
                    <div class="icon-ring">
                        <div class="w-24 h-24 <?php echo $step['color']; ?>/10 rounded-full flex items-center justify-center mx-auto border border-indigo-100 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-xl">
                            <i data-lucide="<?php echo $step['icon']; ?>" class="w-10 h-10 text-indigo-500 dark:text-indigo-400"></i>
                        </div>
                    </div>
                    <div class="absolute -top-2 -right-2 w-9 h-9 <?php echo $step['color']; ?> rounded-full flex items-center justify-center text-white text-xs font-black shadow-lg"><?php echo $step['num']; ?></div>
                </div>
                <h3 class="text-xl font-heading font-bold text-slate-900 dark:text-white mb-3"><?php echo $step['title']; ?></h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 reveal-right">
                ...
                <div class="glass-card p-5 rounded-2xl border flex items-start gap-4 reveal" style="transition-delay:<?php echo $i*0.08; ?>s">
                    <div class="w-10 h-10 flex-shrink-0 rounded-xl flex items-center justify-center border <?php echo $f['color']; ?>">
                        <i data-lucide="<?php echo $f['icon']; ?>" class="w-5 h-5"></i>
                    </div>
                    <div>
                        <h4 class="font-bold text-slate-900 dark:text-white text-sm mb-1"><?php echo $f['title']; ?></h4>
                        <p class="text-slate-500 dark:text-gray-400 text-xs leading-relaxed"><?php echo $f['desc']; ?></p>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
...
<section class="py-12 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 overflow-hidden relative">
    <div class="absolute inset-0 opacity-10" style="background-image: linear-gradient(rgba(255,255,255,0.5) 1px, transparent 1px), linear-gradient(to right, rgba(255,255,255,0.5) 1px, transparent 1px); background-size: 30px 30px;"></div>
        ...
        <div class="space-y-1 reveal">
            ...
            <div class="faq-item py-5 cursor-pointer" onclick="toggleFaq(this)">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex-shrink-0 w-8 h-8 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-400 faq-icon transition-transform duration-300">
                        <i data-lucide="plus" class="w-4 h-4"></i>
                    </div>
                </div>
                <div class="faq-answer">
                    <p class="text-slate-500 dark:text-gray-400 text-sm leading-relaxed pt-4 pr-12"><?php echo $faq['a']; ?></p>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<section class="py-24 bg-slate-50 dark:bg-gray-950 border-t border-slate-100 dark:border-gray-900">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative glass-card rounded-[40px] p-10 md:p-20 text-center overflow-hidden border border-slate-200 dark:border-gray-800 shadow-2xl shadow-slate-200/30 dark:shadow-none reveal">
            <!-- Decorative glow elements -->
            <div class="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-indigo-500/15 dark:bg-indigo-500/25 rounded-full blur-[80px] -mt-20 pointer-events-none"></div>
            <div class="absolute bottom-0 right-0 w-48 h-48 bg-purple-500/10 dark:bg-purple-500/20 rounded-full blur-[60px] pointer-events-none"></div>

            <!-- Animated badge -->
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/25 rounded-full text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-widest mb-7">
            ...
            <p class="mt-5 text-slate-400 dark:text-gray-600 text-xs font-bold uppercase tracking-widest">No spam. Unsubscribe anytime.</p>
        </div>
    </div>
</section>
