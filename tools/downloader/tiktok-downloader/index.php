...
<section class="pt-12 pb-8 bg-gray-950">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div class="px-4 py-2 rounded-xl bg-pink-500/10 border border-pink-500/20 flex items-center gap-2 text-pink-400">
                <i data-lucide="music" class="w-5 h-5"></i>
                <span class="text-sm font-medium">No watermark</span>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="url-form" class="animate-fade-in mb-12">
            ...
            <div class="relative group">
                ...
                <input type="url" name="url" required class="block w-full pl-14 pr-32 py-5 rounded-3xl bg-gray-900 border border-gray-800 text-lg text-white focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all shadow-2xl" placeholder="Paste TikTok link here...">
                <button type="submit" class="absolute right-3 top-2.5 px-6 py-2.5 rounded-2xl bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold hover:from-pink-400 hover:to-red-400 transition-all flex items-center gap-2">Fetch Info <i data-lucide="zap" class="w-4 h-4"></i></button>
            </div>
        </form>

        <div id="progress-overlay" class="hidden animate-fade-in py-20 text-center"><div class="relative w-24 h-24 mx-auto mb-8"><div class="absolute inset-0 border-4 border-gray-800 rounded-full"></div><div class="absolute inset-0 border-4 border-pink-500 rounded-full border-t-transparent animate-spin"></div></div><h3 class="text-2xl font-bold text-white mb-2">Analyzing URL</h3><p class="text-gray-400">This may take a few seconds...</p></div>
            ...
            <div class="glass-card rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row gap-8">
                ...
                <div class="w-full md:w-2/3">
                    ...
                    <form id="download-form" action="process.php" method="POST">
                        ...
                        <button type="submit" class="w-full py-4 rounded-2xl bg-gradient-to-r from-pink-500 to-red-500 text-white font-extrabold text-lg hover:from-pink-400 hover:to-red-400 shadow-xl transition-all flex items-center justify-center gap-2"><i data-lucide="download" class="w-6 h-6"></i> Download Selected</button>
                    </form>
                </div>
            </div>
        </div>

        <div id="final-download" class="hidden animate-fade-in py-12"><div class="glass-card rounded-[40px] p-8 md:p-12 text-center border-pink-500/20"><div class="w-20 h-20 bg-green-500/10 rounded-3xl flex items-center justify-center text-green-500 mx-auto mb-8"><i data-lucide="check-circle" class="w-12 h-12"></i></div><h2 class="text-3xl font-bold text-white mb-4">File is Ready!</h2><div class="flex gap-4 justify-center mt-10"><a id="final-btn" href="#" class="px-10 py-5 rounded-3xl bg-gradient-to-r from-pink-500 to-red-500 text-white font-extrabold text-lg flex items-center gap-2"><i data-lucide="download" class="w-6 h-6"></i> Download File</a></div></div></div>
    </div>
</section>
