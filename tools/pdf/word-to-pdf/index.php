        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div class="flex gap-3">
                <div class="px-4 py-2 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center gap-2 text-blue-400">
                    ...
                    <span class="text-sm font-medium">Supports DOC, DOCX</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="tool-form" class="animate-fade-in" method="POST" enctype="multipart/form-data">
            ...
            <div class="upload-zone rounded-[40px] p-12 text-center cursor-pointer group mb-10">
                <input type="file" name="file" id="file-input" class="hidden" accept=".doc,.docx">
                
                <div class="w-20 h-20 bg-blue-600/10 rounded-full flex items-center justify-center text-blue-400 mx-auto mb-8 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                    <i data-lucide="file-text" class="w-10 h-10"></i>
                </div>
                
                <h2 class="text-2xl font-bold text-white mb-3">Select Word File</h2>
                <p class="text-gray-400 mb-8">Choose DOC or DOCX (Max 20MB)</p>
                
                <div class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-blue-600 text-white font-bold hover:bg-blue-500 shadow-lg shadow-blue-600/20 transition-all">
                    Browse Word Doc
                </div>
        ...
        <div id="progress-overlay" class="hidden animate-fade-in py-20 text-center">
            ...
            <h3 class="text-2xl font-bold text-white mb-2">Converting Word to PDF</h3>
            <p class="text-gray-400 mb-8">Processing with LibreOffice Engine...</p>
        </div>
        ...
        <div id="result-section" class="hidden animate-fade-in py-12">
            <div class="glass-card rounded-[40px] p-8 md:p-12 text-center border-indigo-500/20 shadow-indigo-500/10">
                ...
                <h2 class="text-3xl font-bold text-white mb-4">Word converted to PDF!</h2>
