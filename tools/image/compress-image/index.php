        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div class="flex gap-3">
                <div class="px-4 py-2 rounded-xl bg-gray-900 border border-gray-800 flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium text-gray-300">Fast Compression</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="pb-24 bg-gray-950">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="tool-form" class="animate-fade-in" method="POST" enctype="multipart/form-data">
            ...
            <div class="glass-card rounded-3xl p-8 mb-10">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <span id="quality-val" class="px-3 py-1 bg-indigo-600 text-white rounded-full text-xs font-bold">75%</span>
                </div>
                
                <div>
                    <input type="range" name="quality" id="quality-slider" min="10" max="100" value="75" class="w-full h-2 bg-gray-800 rounded-lg appearance-none cursor-pointer accent-indigo-500">
                    <div class="flex justify-between text-[11px] text-gray-500 mt-3 font-medium uppercase tracking-wider">
            ...
            <button type="submit" class="w-full py-5 rounded-3xl bg-indigo-600 text-white font-extrabold text-lg hover:bg-indigo-500 shadow-2xl shadow-indigo-600/30 transition-all flex items-center justify-center gap-3">
                Compress Image <i data-lucide="arrow-right" class="w-6 h-6"></i>
            </button>
        </form>
        ...
        <div id="progress-overlay" class="hidden animate-fade-in py-20 text-center">
            ...
            <h3 class="text-2xl font-bold text-white mb-2">Optimizing Image</h3>
            <p class="text-gray-400 mb-8">Reducing size while keeping quality...</p>
        </div>
        ...
        <div id="result-section" class="hidden animate-fade-in py-12">
            <div class="glass-card rounded-[40px] p-8 md:p-12 text-center border-indigo-500/20 shadow-indigo-500/10">
                ...
                <h2 class="text-3xl font-bold text-white mb-4">Compression Complete!</h2>
                <p id="savings-text" class="text-indigo-400 font-bold mb-10">Saved 45% (1.2 MB → 650 KB)</p>
